...
const subjectDetails = {
  ...
  'Operating System':['Unit 1: Introduction','Unit 2: Process Management','Unit 3: Process Synchronization','Unit 4: Deadlocks','Unit 5: Memory Management','Unit 6: File Systems And Secondary Storage Management'],
  'Computer Networks':['Unit 1: Introduction','Unit 2: The Data Link Layer','Unit 3: The Network Layer','Unit 4: The Transport Layer:','Unit 5: The Application Layer','Unit 6: Network Security'],
  'Software Engineering':['Unit 1: Introduction','Unit 2: Software Project management','Unit 3: Software design','Unit 4: Coding','Unit 5: Testing','Unit 6: Software Reliability And Quality Management'],
